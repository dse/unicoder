package Unicoder::AdobeGlyphNames;
use warnings;
use strict;
...
# get_glyph_name(<codepoint>, [<strict-flag>])
#
# returns a glyph name like "asciitilde".
#
# If <codepoint> is a single-character string that isn't an ASCII
# digit, it gets the codepoint for that character.
#
# If no glyph name is listed, returns something like "char2511"
# containing the decimal codepoint.
#
# If the strict flag is specified and truthy, and no glyph name is
# listed, returns undef.
sub get_glyph_name {
